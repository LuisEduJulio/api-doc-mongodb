...
{
    public class CustomerCreateDtoFixture
    {
        public CustomerCreateDtoFixture()
        {
        }
        public CustomerCreateDto CustomerCreateDtoMock()
        {
            var CustomerCreateDtoFixture = new Faker<CustomerCreateDto>("pt_BR")
            ...
            return CustomerCreateDtoFixture;
        }
    }
}
